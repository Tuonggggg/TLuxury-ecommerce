// src/pages/layout/OrderDetailsPage.jsx
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            ...
            try {
                ...
                // Optional: Nếu lỗi, chuyển hướng về trang đơn hàng của tôi
                // navigate('/my-orders'); 
            } finally {
                setLoading(false);
            }
    ...
    if (!order) {
        return (
            <div className="text-center py-16">
                ...
                <h1 className="text-2xl font-bold mb-2">Lỗi: Không tìm thấy đơn hàng</h1>
        ...
        <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                    ...
                    <p className="text-sm"><strong>Người nhận:</strong> {shippingAddress.name}</p>
